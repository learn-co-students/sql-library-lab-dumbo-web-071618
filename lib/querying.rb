def select_books_titles_and_years_in_first_series_order_by_year
  "SELECT books.title, books.year FROM books INNER JOIN series ON series.id = books.series_id WHERE series.id = 1 GROUP BY books.year ORDER BY books.year;"
end
...
def select_value_and_count_of_most_prolific_species
  #Find species with most characters
...
def select_name_and_series_subgenres_of_authors
  #Return author's name and their series subgenres
